...
?>
<div id="leaderwrap">
<button onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('http://nsit-moksha.com/vimukti/leader.php'),'facebook-share-dialog', 'width=626,height=436');">Share Your Stats</button>
